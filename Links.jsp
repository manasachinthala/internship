		...
		<div class="container">
			...
			<section class="color-10">
				<nav class="cl-effect-10" id="cl-effect-10">
					<a href="othergroup.jsp" data-hover="Request File to Other Group"><span>Request File to Other Group</span></a>
					<a href="othergroupdownload.jsp" data-hover="Download to Other Group Files"><span>Download to Other Group Files</span></a>
					<a href="download.jsp" data-hover="Sign out Here"><span>Sign out Here</span></a>
