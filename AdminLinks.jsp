		...
		<div class="container">
			...
			<section class="color-5">
				<nav class="cl-effect-19" id="cl-effect-19">
					<a href="Reg.jsp"><span data-hover="Ratatouille">User Registration Form</span></a>
					<a href="groupname.jsp"><span data-hover="Lassitude">Create a New GroupName Here</span></a>
					<a href="userdelete.jsp"><span data-hover="Murmurous">User Revocation Details</span></a>
